/* Generated by Cython 0.19.1 on Sat Feb 15 13:08:56 2014 */
...
static std::pair<__pyx_t_3kNN_6cppext_10similarity_vectmap,__pyx_t_3kNN_6cppext_10similarity_vectmap> __pyx_f_3kNN_6cppext_10similarity_cossim2(__pyx_t_3kNN_6cppext_10similarity_iddict &__pyx_v_d_i, __pyx_t_3kNN_6cppext_10similarity_mapvect &__pyx_v_t_X, int __pyx_v_k, __pyx_t_3kNN_6cppext_10similarity_vectvect &__pyx_v_t_Y, __pyx_t_3kNN_6cppext_10similarity_isdict &__pyx_v_parents_index, __pyx_t_3kNN_6cppext_10similarity_isdict &__pyx_v_children_index, __pyx_t_3kNN_6cppext_10similarity_isetdict &__pyx_v_idx) {
  std::tr1::unordered_set<int> __pyx_v_doc_nums;
  __pyx_t_3kNN_6cppext_10similarity_iddictitr __pyx_v_it;
  int __pyx_v_word;
  __pyx_t_3kNN_6cppext_10similarity_isetdictitr __pyx_v_got;
  std::tr1::unordered_set<int> __pyx_v_dns;
  std::tr1::unordered_set<int>::iterator __pyx_v_it2;
  std::tr1::unordered_map<int,double> __pyx_v_doc;
  int __pyx_v_doc_num;
  std::vector<int> __pyx_v_labels;
  int __pyx_v_d_i_size;
  int __pyx_v_doc_size;
  std::pair<int,double> __pyx_v_kv;
  ...
  std::vector<std::pair<int,double> >::iterator __pyx_v_it3;
  CYTHON_UNUSED int __pyx_v_i;
  int __pyx_v_j;
  __pyx_t_3kNN_6cppext_10similarity_vectmap __pyx_v_scores;
  __pyx_t_3kNN_6cppext_10similarity_vectmap __pyx_v_pscores;
  std::tr1::unordered_set<int> __pyx_v_parents_set;
  std::tr1::unordered_set<int>::iterator __pyx_v_it4;
  int __pyx_v_parent;
  std::tr1::unordered_set<int> __pyx_v_children_set;
  CYTHON_UNUSED int __pyx_v_smaller_size;
  std::pair<__pyx_t_3kNN_6cppext_10similarity_vectmap,__pyx_t_3kNN_6cppext_10similarity_vectmap> __pyx_r;
  __Pyx_RefNannyDeclarations
  ...
  int __pyx_t_3;
  int __pyx_t_4;
  std::tr1::unordered_set<int> __pyx_t_5;
  int __pyx_t_6;
  __pyx_t_3kNN_6cppext_10similarity_idpair __pyx_t_7;
  std::vector<double> __pyx_t_8;
  int __pyx_t_9;
  double __pyx_t_10;
  std::pair<__pyx_t_3kNN_6cppext_10similarity_vectmap,__pyx_t_3kNN_6cppext_10similarity_vectmap> __pyx_t_11;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
 ...
 */
  __pyx_t_1 = PyInt_FromLong(__pyx_v_d_i_size); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 218; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s__size); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 218; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_3 = __Pyx_PyInt_AsInt(__pyx_t_1); if (unlikely((__pyx_t_3 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 218; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_d_i_size = __pyx_t_3;
 ...
 */
  while (1) {
    __pyx_t_4 = ((__pyx_v_it != __pyx_v_d_i.end()) != 0);
    if (!__pyx_t_4) break;
 ...
 *         if got != idx.end():
 */
    __pyx_v_got = __pyx_v_idx.find(__pyx_v_word);
 ...
 *             it2 = dns.begin()
 */
    __pyx_t_4 = ((__pyx_v_got != __pyx_v_idx.end()) != 0);
    if (__pyx_t_4) {
 ...
 *             while it2 != dns.end():
 */
      __pyx_t_5 = (*__pyx_v_got).second;
      __pyx_v_dns = __pyx_t_5;
 ...
 */
      while (1) {
        __pyx_t_4 = ((__pyx_v_it2 != __pyx_v_dns.end()) != 0);
        if (!__pyx_t_4) break;
 ...
 */
  while (1) {
    __pyx_t_4 = ((__pyx_v_it2 != __pyx_v_doc_nums.end()) != 0);
    if (!__pyx_t_4) break;
 ...
 *             it = doc.begin()
 */
    __pyx_t_4 = ((__pyx_v_doc_size <= __pyx_v_d_i_size) != 0);
    if (__pyx_t_4) {

      /* "kNN/cppext/similarity.pyx":256
 *         top = 0
 *         if doc_size <= d_i_size:
 *             smaller_size = doc_size             # <<<<<<<<<<<<<<
 *             it = doc.begin()
 ...
 */
      while (1) {
        __pyx_t_4 = ((__pyx_v_it != __pyx_v_doc.end()) != 0);
        if (!__pyx_t_4) break;

        /* "kNN/cppext/similarity.pyx":259
 *             it = doc.begin()
 *             while it != doc.end():
 *                 kv = deref(it)             # <<<<<<<<<<<<<<
 *                 inc(it)
 ...
 *         else:
 */
        __pyx_t_4 = ((__pyx_v_got2 != __pyx_v_d_i.end()) != 0);
        if (__pyx_t_4) {

          /* "kNN/cppext/similarity.pyx":263
 *                 got2 = d_i.find(kv.first)
 *                 if got2 != d_i.end():
 *                     top += kv.second * deref(got2).second             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
        __pyx_t_4 = ((__pyx_v_got2 != __pyx_v_doc.end()) != 0);
        if (__pyx_t_4) {
 ...
 *             doc_scores.push_back(idpair(label,score))
 */
    __pyx_t_3 = ((int)__pyx_v_labels.size());
 ...
 */
      try {
        __pyx_t_7 = __pyx_t_3kNN_6cppext_10similarity_idpair(__pyx_v_label, __pyx_v_score);
      } catch(...) {
        __Pyx_CppExn2PyErr();
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 282; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __pyx_v_doc_scores.push_back(__pyx_t_7);
 ...
 *             cat_scores_dict[label].push_back(score)
 */
      __pyx_t_4 = ((__pyx_v_got3 == __pyx_v_cat_scores_dict.end()) != 0);
      if (__pyx_t_4) {

        /* "kNN/cppext/similarity.pyx":285
 *             got3 = cat_scores_dict.find(label)
 *             if got3 == cat_scores_dict.end():
 *                 cat_scores_dict[label] = vector[double]()             # <<<<<<<<<<<<<<
 *             cat_scores_dict[label].push_back(score)
 ...
 */
        ...
        (__pyx_v_cat_scores_dict[__pyx_v_label]) = __pyx_t_8;
        goto __pyx_L20;
      }
      __pyx_L20:;
 ...
 *         scores[label].push_back(score)
 */
    __pyx_t_4 = ((__pyx_v_got3 == __pyx_v_scores.end()) != 0);
    if (__pyx_t_4) {
 ...
 */
      ...
      (__pyx_v_scores[__pyx_v_label]) = __pyx_t_8;
      goto __pyx_L23;
    }
    __pyx_L23:;
 ...
 */
    while (1) {
      __pyx_t_4 = ((__pyx_v_it4 != __pyx_v_parents_set.end()) != 0);
      if (!__pyx_t_4) break;
 ...
 *             pscores[label].push_back(<double>children_set.size())
 */
      __pyx_t_4 = ((__pyx_v_got3 == __pyx_v_pscores.end()) != 0);
      if (__pyx_t_4) {
 ...
 */
        ...
        (__pyx_v_pscores[__pyx_v_label]) = __pyx_t_8;
        goto __pyx_L26;
      }
      __pyx_L26:;
 ...
 */
  try {
    __pyx_t_11 = std::pair<__pyx_t_3kNN_6cppext_10similarity_vectmap,__pyx_t_3kNN_6cppext_10similarity_vectmap>(__pyx_v_scores, __pyx_v_pscores);
  } catch(...) {
    __Pyx_CppExn2PyErr();
...
static int __Pyx_InitCachedBuiltins(void) {
  #if PY_MAJOR_VERSION >= 3
  __pyx_builtin_xrange = __Pyx_GetBuiltinName(__pyx_n_s__range); if (!__pyx_builtin_xrange) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  #else
  __pyx_builtin_xrange = __Pyx_GetBuiltinName(__pyx_n_s__xrange); if (!__pyx_builtin_xrange) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  #endif
  return 0;
  __pyx_L1_error:;
  return -1;
