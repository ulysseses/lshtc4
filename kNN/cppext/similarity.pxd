...
cdef void cossim2(unordered_map[int, double]&, vector[unordered_map[int,double]]&, int, vector[vector[int]]&, unordered_map[int, unordered_set[int]]&, unordered_map[int, unordered_set[int]]&, unordered_map[int, unordered_set[int]]&)
